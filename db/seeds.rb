...
# alberta = Province.find(1)
# alberta.province = "Alberta"
# alberta.save

# britishcolumbia = Province.find(2)
# britishcolumbia.province = "British Columbia"
# britishcolumbia.save

# manitoba = Province.find(3)
# manitoba.province = "Manitoba"
# manitoba.save

# newbrunswick = Province.find(4)
# newbrunswick.province = "New Brunswick"
# newbrunswick.save

# newfoundland = Province.find(5)
# newfoundland.province = "Newfoundland and Labrador"
# newfoundland.save

# novascotia = Province.find(6)
# novascotia.province = "Nova Scotia"
# novascotia.save

# ontario = Province.find(7)
...
# quebec = Province.find(9)
# quebec.province = "Quebec"
# quebec.save

# saskatchewan = Province.find(10)
# saskatchewan.province = "Saskatchewan"
# saskatchewan.save

# northwest = Province.find(11)
# northwest.province = "Northwest Territories"
# northwest.save

# nunavut = Province.find(12)
# nunavut.province = "Nunavut"
# nunavut.save

# yukon = Province.find(13)
